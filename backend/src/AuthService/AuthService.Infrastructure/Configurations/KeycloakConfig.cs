...
public class KeycloakConfig
{
    ...
    public KeycloakConfig(string? url, string? realm, string? clientId, string? clientUuid, string? clientSecret, string? adminUsername, string? adminPassword)
    {
        ...
        ClientUuid = clientUuid ?? throw new ArgumentNullException(nameof(clientUuid), "Keycloak ClientUuid is not configured.");
