...
namespace WorkoutService.Persistence.Migrations
{
    ...
    [Migration("20250222150138_AddSetUpProfileFunctionality")]
    partial class AddSetUpProfileFunctionality
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WorkoutService.Domain.Entities.ExerciseHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("WorkoutService.Domain.Entities.SetHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("WorkoutService.Domain.Entities.WorkoutHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("WorkoutService.Domain.Entities.ExerciseHistory", b =>
                {
                    ...
                    b.HasOne("WorkoutService.Domain.Entities.WorkoutHistory", "WorkoutHistory")
            ...
            modelBuilder.Entity("WorkoutService.Domain.Entities.SetHistory", b =>
                {
                    b.HasOne("WorkoutService.Domain.Entities.ExerciseHistory", "ExerciseHistory")
                        .WithMany("SetHistories")
            ...
            modelBuilder.Entity("WorkoutService.Domain.Entities.WorkoutHistory", b =>
                {
                    b.HasOne("WorkoutService.Domain.Entities.User", null)
