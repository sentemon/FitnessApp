...
import {ActivitiesHistoryComponent} from "./features/workouts/components/activities-history/activities-history.component";
...
const routes: Routes = [
  ...
  { path: 'workouts/history', component: ActivitiesHistoryComponent, canActivate: [AuthGuard] },
